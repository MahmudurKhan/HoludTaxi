...
<body  onLoad="javascript:getCurrentLocation()">
	...
	<div class="row login_box" align="center">
        ...
        <div class="col-md-12 col-xs-12 login_control">
                <form class="form-horizontal" role="form" method="post" action="vacant.php">
                <div class="control">
                    <div class="label">Car Registration Number</div>
                    <input name="carno" type="text" class="form-control" id="carno" placeholder="Enter Car Number"/>
                </div>
                ...
                <div align="center">
                     <button type = "submit" class="btn btn-orange" id= "button" >LOGIN</button>
                </div>     
