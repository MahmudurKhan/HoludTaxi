...
<body  onLoad="javascript:getCurrentLocation()">
	...
	<div class="row login_box" align="center">
        ...
        <div class="col-md-12 col-xs-12 login_control">
                ...
                <div align="center">
                     <a href="wait.php" class="btn btn-red-2" id= "button" formaction="wait.php">Use Current Location</a>
                     <a href="cmap.php"  class="btn btn-red-2" id= "button2" formaction="cmap.php" >Use Custom Location</a>
                </div>     
